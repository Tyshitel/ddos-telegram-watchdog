...
MAX_RX_MBPS Порог входящего трафика (Mbps). Если входящий поток выше 45 Mbp, будет алерт. Обнаруживает:

volumetric DDoS
UDP flood
packet flood Для 100 Mbps канала: 45 Для 1 Gbit: 200 300 500
MAX_CONN_PER_IP Максимум соединений от одного IP. Ловит:
